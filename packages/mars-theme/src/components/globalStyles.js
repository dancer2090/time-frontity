...
import MLE from '../fonts/Montserrat-Light.eot';
import MLS from '../fonts/Montserrat-Light.svg';
import MLT from '../fonts/Montserrat-Light.ttf';
import MLW from '../fonts/Montserrat-Light.woff';
import MLW2 from '../fonts/Montserrat-Light.woff2';

import MLIE from '../fonts/Montserrat-LightItalic.eot';
import MLIS from '../fonts/Montserrat-LightItalic.svg';
import MLIT from '../fonts/Montserrat-LightItalic.ttf';
import MLIW from '../fonts/Montserrat-LightItalic.woff';
import MLIW2 from '../fonts/Montserrat-LightItalic.woff2';
...
@font-face {
  font-family: 'Montserrat';
  src: url('${MLE}');
  src: url('${MLE}?#iefix') format('embedded-opentype'),
       url('${MLS}#Montserrat-Light') format('svg'),
       url('${MLT}') format('truetype'),
       url('${MLW}') format('woff'),
       url('${MLW2}') format('woff2');
  font-weight: 300;
  font-style: normal;
  font-display: swap;
}
@font-face {
  font-family: 'Montserrat';
  src: url('${MLIE}');
  src: url('${MLIE}?#iefix') format('embedded-opentype'),
       url('${MLIS}#Montserrat-LightItalic') format('svg'),
       url('${MLIT}') format('truetype'),
       url('${MLIW}') format('woff'),
       url('${MLIW2}') format('woff2');
  font-weight: 300;
  font-style: italic;
  font-display: swap;
}
